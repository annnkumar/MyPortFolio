...
export const skills: Skill[] = [
  ...
  },
  {
    name: "ML & AI",
    icon: "fas fa-brain",
    description: "EDA, Supervised & Unsupervised Learning, Time Series Forecasting",
    category: "ml-ai"
  },
  {
    name: "Development",
...
export const projects: Project[] = [
  {
    ...
    description: "Built a UPI fraud detection system using ML models to identify suspicious transactions.",
  ...
  },
  {
    ...
    description: "Developed a desktop-based electric billing system to manage consumer electricity usage and automate bill generation.",
  ...
  },
  {
    ...
    description: "Performed comprehensive data collection, EDA, and feature engineering to prepare forest weather data for predictive modeling.",
